...
void HelpMenu(int stop){
    ...
    else if(in==11){  //added missing detail
        cout<<endl;
        cout<<"Fire Employee"<<endl;
        cout<<"Deletes specified employee from the tree"<<endl;
        cout<<"Specified employee must have no subordinates, so a preliminary shift is necessary"<<endl;
        cout<<"Specified employee is deleted if conditions are met, superiors and juniors are re-linked"<<endl;
        cout<<endl;
    }
		else if(in==12){
				cout<<endl;
